<?php
	...
	if (isset($noticias) && $noticias == "on") {
			...
			<div>
				<table align='center' border='0' cellpadding='0' cellspacing='0'>
			 		<tbody>
			 			<tr>
			 				<td width='11'>
			 					<img src='http://suzukimorelia.com.mx/images/spacer.png' style='display: block; border: 0' border='0'>
			 				</td>
				 					...
				 					<tbody>
				 						<tr>
				 							<td height='52' width='102'>
				 								<a style='display: block; border: 0' href='http://suzukimorelia.com.mx' target='_blank' rel='noreferrer'>
				 									<img style='display: block; border: 0' src='http://suzukimorelia.com.mx/images/template/common/header/horizontal_logo.png' border='0'>
			 									</a>
				 							</td>
				 						</tr>
				 					</tbody>
						...
						<tr>
							<td height='11' valign='top' width='11'>
								<img style='display:block;border:0' src='http://suzukimorelia.com.mx/images/shadow-left.png' border='0' class='CToWUd'>
							</td>
									...
									<tbody>
										<tr>
											<td height='14' width='15'>
		 										<img style='display: block; border: 0' src='http://suzukimorelia.com.mx/images/footer-logo.png' border='0'>
		 									</td>
		 									<td width='125px'>
		 										<p style='color: #ffffff; font-family: Lato, Arial, sans-serif; font-size: 12px; font-weight: 700; text-align: right; padding: 0'>
		 											<a style='color: #0059a9' href='http://suzukimorelia.com.mx/' target='_blank' rel='noreferrer'>suzukimorelia.com.mx</a>
		 										</p>

		 									</td>
		 									<td>
		 										<p style='color: #000000; font-family: Lato, Arial, sans-serif; font-size: 11px; text-align: right; padding: 0'>
		 											&nbsp;© 2015 Suzuki Motor de México / Morelia
		 										</p>
		 									</td>
										</tr>
									</tbody>
							...
							<td height='11' valign='top' width='11'>
								<img style='display:block;border:0' src='http://suzukimorelia.com.mx/images/shadow-right.png' border='0' class='CToWUd'>
							</td>
						</tr>
						<tr>
							<td width='11'>
								<img src='http://suzukimorelia.com.mx/images/spacer.png' style='display:block;border:0' border='0' class='CToWUd'>
							</td>
							<td width='11'>
								<img src='http://suzukimorelia.com.mx/images/spacer.png' style='display:block;border:0' border='0' class='CToWUd'>
							</td>
		...
		");
		$respuesta2 = mail("webmaster@medigraf.com.mx", "Financiamiento Newsletter - Suzuki Morelia.", $mensaje2, $encabezados2);
		//$respuesta2 = mail("heriberto@medigraf.com.mx", "Financiamiento Newsletter - Suzuki Morelia.", $mensaje2, $encabezados2);
		if ( $respuesta2 == true) {
							...
							<table style='padding:35px 60px 35px' border='0' cellpadding='0' cellspacing='0' width='600'>
								<tbody>
									<tr>
			 							...
			 							<td height='20' valign='top'>
		 									<img src='http://suzukimorelia.com.mx/images/template/common/header/$image_modelo' alt='Modelo'>
			 							</td>
		 							</tr>
	 								<tr>
	...
	");
	$respuesta = mail('gtepostventa@suzukimorelia.com.mx', 'Financiamiento - Solicitud de la pagina de internet Suzuki Morelia para cotizar.', $mensaje, $encabezados);
	//$respuesta = mail("cold_space@hotmail.com", "Financiamiento - Solicitud de la pagina de internet Suzuki Morelia para cotizar.", $mensaje, $encabezados);
	if ( $respuesta == true) {
    ...
    header ('Location: http://suzukimorelia.com.mx/');
    exit();
?>
